...
instance Print AbsGarpezpp.Boolean where
  prt _ (AbsGarpezpp.Boolean i) = doc (showString i)
...
instance Print AbsGarpezpp.PassBy where
  prt i e = case e of
    AbsGarpezpp.PassBy_ -> prPrec i 0 (concatD [])
    AbsGarpezpp.PassBy1 -> prPrec i 0 (concatD [doc (showString "&")])
...
instance Print AbsGarpezpp.Compound where
  prt i e = case e of
    ...
    AbsGarpezpp.Array rexp compound -> prPrec i 0 (concatD [doc (showString "["), prt 0 rexp, doc (showString "]"), prt 0 compound])
    AbsGarpezpp.Pointer compound -> prPrec i 0 (concatD [doc (showString "*"), prt 0 compound])

instance Print AbsGarpezpp.Basic where
  prt i e = case e of
    AbsGarpezpp.Basic_bool -> prPrec i 0 (concatD [doc (showString "bool")])
    AbsGarpezpp.Basic_char -> prPrec i 0 (concatD [doc (showString "char")])
    AbsGarpezpp.Basic_int -> prPrec i 0 (concatD [doc (showString "int")])
    AbsGarpezpp.Basic_float -> prPrec i 0 (concatD [doc (showString "float")])
    AbsGarpezpp.Basic_string -> prPrec i 0 (concatD [doc (showString "string")])

instance Print AbsGarpezpp.RType where
  prt i e = case e of
    AbsGarpezpp.RTypeBasic basic -> prPrec i 0 (concatD [prt 0 basic])
    AbsGarpezpp.RType1 type_ -> prPrec i 0 (concatD [prt 0 type_, doc (showString "&")])
...
instance Print AbsGarpezpp.Jump where
  prt i e = case e of
    AbsGarpezpp.Jump_return -> prPrec i 0 (concatD [doc (showString "return")])
    AbsGarpezpp.Jump1 rexp -> prPrec i 0 (concatD [doc (showString "return"), prt 0 rexp])
    AbsGarpezpp.Jump_break -> prPrec i 0 (concatD [doc (showString "break")])
    AbsGarpezpp.Jump_continue -> prPrec i 0 (concatD [doc (showString "continue")])

instance Print AbsGarpezpp.LExp where
  prt i e = case e of
    AbsGarpezpp.Deref lexp -> prPrec i 0 (concatD [doc (showString "*"), prt 1 lexp])
...
instance Print AbsGarpezpp.PRead where
  prt i e = case e of
    AbsGarpezpp.PRead_readChar -> prPrec i 0 (concatD [doc (showString "readChar")])
    AbsGarpezpp.PRead_readInt -> prPrec i 0 (concatD [doc (showString "readInt")])
    AbsGarpezpp.PRead_readFloat -> prPrec i 0 (concatD [doc (showString "readFloat")])
    AbsGarpezpp.PRead_readString -> prPrec i 0 (concatD [doc (showString "readString")])

instance Print AbsGarpezpp.PWrite where
  prt i e = case e of
    AbsGarpezpp.PWrite_writeChar -> prPrec i 0 (concatD [doc (showString "writeChar")])
    AbsGarpezpp.PWrite_writeInt -> prPrec i 0 (concatD [doc (showString "writeInt")])
    AbsGarpezpp.PWrite_writeFloat -> prPrec i 0 (concatD [doc (showString "writeFloat")])
    AbsGarpezpp.PWrite_writeString -> prPrec i 0 (concatD [doc (showString "writeString")])

instance Print AbsGarpezpp.AssignOp where
  prt i e = case e of
    AbsGarpezpp.AssignOp1 -> prPrec i 0 (concatD [doc (showString "=")])
    AbsGarpezpp.AssignOp2 -> prPrec i 0 (concatD [doc (showString "+=")])
    AbsGarpezpp.AssignOp3 -> prPrec i 0 (concatD [doc (showString "-=")])
    AbsGarpezpp.AssignOp4 -> prPrec i 0 (concatD [doc (showString "*=")])
    AbsGarpezpp.AssignOp5 -> prPrec i 0 (concatD [doc (showString "/=")])
    AbsGarpezpp.AssignOp6 -> prPrec i 0 (concatD [doc (showString "%=")])
    AbsGarpezpp.AssignOp7 -> prPrec i 0 (concatD [doc (showString "^=")])
    AbsGarpezpp.AssignOp8 -> prPrec i 0 (concatD [doc (showString "&=")])
    AbsGarpezpp.AssignOp9 -> prPrec i 0 (concatD [doc (showString "|=")])

instance Print AbsGarpezpp.CompOp where
  prt i e = case e of
    AbsGarpezpp.CompOp1 -> prPrec i 0 (concatD [doc (showString "<")])
    AbsGarpezpp.CompOp2 -> prPrec i 0 (concatD [doc (showString "<=")])
    AbsGarpezpp.CompOp3 -> prPrec i 0 (concatD [doc (showString "==")])
    AbsGarpezpp.CompOp4 -> prPrec i 0 (concatD [doc (showString "!=")])
    AbsGarpezpp.CompOp5 -> prPrec i 0 (concatD [doc (showString ">=")])
    AbsGarpezpp.CompOp6 -> prPrec i 0 (concatD [doc (showString ">")])

instance Print AbsGarpezpp.IncDecOp where
  prt i e = case e of
    AbsGarpezpp.IncDecOp1 -> prPrec i 0 (concatD [doc (showString "++")])
    AbsGarpezpp.IncDecOp2 -> prPrec i 0 (concatD [doc (showString "--")])

instance Print AbsGarpezpp.SignOp where
  prt i e = case e of
    AbsGarpezpp.SignOp1 -> prPrec i 0 (concatD [doc (showString "+")])
    AbsGarpezpp.SignOp2 -> prPrec i 0 (concatD [doc (showString "-")])

instance Print AbsGarpezpp.Literal where
  prt i e = case e of
    AbsGarpezpp.LiteralBoolean boolean -> prPrec i 0 (concatD [prt 0 boolean])
    AbsGarpezpp.LiteralChar c -> prPrec i 0 (concatD [prt 0 c])
    AbsGarpezpp.LiteralInteger n -> prPrec i 0 (concatD [prt 0 n])
    AbsGarpezpp.LiteralDouble d -> prPrec i 0 (concatD [prt 0 d])
    AbsGarpezpp.LiteralString str -> prPrec i 0 (concatD [prt 0 str])
