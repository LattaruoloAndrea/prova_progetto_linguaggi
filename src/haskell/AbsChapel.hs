...
data RExp t
    ...
    | FCall   {reLoc :: Loc, fName :: Ident, rList :: [RExp t], iList :: [Intent], reTy :: t}
...
instance Functor Stm where
  fmap f s = case s of
    ...
    StmCall a b c -> StmCall a (map (fmap f) b) c
...
instance Functor RExp where
  fmap f r = case r of
    ...
    FCall a b c d t -> FCall a b (map (fmap f) c) d (f t)
