...
Stm : ';' Stm { $2 }
    ...
    | LExp '=' RExp ';' { AbsChapel.Assign $1 AbsChapel.AssignEq $3 }
    | LExp '+=' RExp ';' { AbsChapel.Assign $1 AbsChapel.AssignAdd $3 }
    | LExp '-=' RExp ';' { AbsChapel.Assign $1 AbsChapel.AssignSub $3 }
    ...
    | 'if' RExp Block Stm { AbsChapel.If $2 (AbsChapel.StmBlock $3) }
    | 'if' RExp 'then' Stm 'else' Stm { AbsChapel.IfElse $2 $4 $6 }
    | 'if' RExp Block Stm 'else' Stm { AbsChapel.IfElse $2 (AbsChapel.StmBlock $4) $6 }
    ...
    | 'return' ';' { AbsChapel.JmpStm AbsChapel.Return }
    | 'return' RExp ';' { AbsChapel.JmpStm (AbsChapel.ReturnE $2) }
    | 'break' ';' { AbsChapel.JmpStm AbsChapel.Break }
    | 'continue' ';' { AbsChapel.JmpStm AbsChapel.Continue }

Range :: { Range }
Range : '{' RExp '..' RExp '}' { AbsChapel.Range $2 $4 }
...
RExp : RExp '||' RExp { AbsChapel.Or $1 $3 }
     ...
     | RExp '<' RExp { AbsChapel.Comp $1 AbsChapel.Lt $3 }
     | RExp '<=' RExp { AbsChapel.Comp $1 AbsChapel.Le $3 }
     | RExp '==' RExp { AbsChapel.Comp $1 AbsChapel.Eq $3 }
     | RExp '!=' RExp { AbsChapel.Comp $1 AbsChapel.Neq $3 }
     | RExp '>=' RExp { AbsChapel.Comp $1 AbsChapel.Ge $3 }
     | RExp '>' RExp { AbsChapel.Comp $1 AbsChapel.Gt $3 }

     | RExp '+' RExp { AbsChapel.Arith $1 AbsChapel.Add $3 }
     | RExp '-' RExp { AbsChapel.Arith $1 AbsChapel.Sub $3 }
